...
const translations: Record<string, string> = {
  ...
  'about.description': 'El Foro Panamericano de Jóvenes Políticos es una plataforma continental dedicada a la defensa de la libertad frente al socialismo y la cultura woke. Reúne a líderes emergentes de América comprometidos con los valores democráticos tradicionales y la preservación de las libertades fundamentales. En su tercera edición, se realizará en Lima, Perú, esperando la participación de 300 jovenes politicos de todo el continente.',
